package com.fox.storage.service;


import com.fox.common.util.CustomUtil;
import com.fox.storage.entity.Storage;
import com.fox.storage.mapper.StorageMapper;
...
public class StorageService {
    ...
    public void deduct(String commodityCode, int count) {
        ...
        Storage storage = storageMapper.selectByMap( CustomUtil.ofMap(Storage.t.commodityCode, commodityCode)).get(0);
